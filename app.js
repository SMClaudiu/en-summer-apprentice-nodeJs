...
const deleteOrder = require('D:/Facultate/An II/Sem2/Practica/Endava/en-summer-apprentice-nodejs/repository/Orders/delete')
const updateOrder = require('D:/Facultate/An II/Sem2/Practica/Endava/en-summer-apprentice-nodejs/repository/Orders/update')
const postOrder = require('D:/Facultate/An II/Sem2/Practica/Endava/en-summer-apprentice-nodejs/repository/Orders/post')
...
app.use('/api/Orders/removeOrder', deleteOrder);
app.use('/api/Orders/update', updateOrder)
app.use('/api/Orders/create', postOrder)
